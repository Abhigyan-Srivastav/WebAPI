...
namespace BasicEfCoreDemo.Migrations
{
    ...
    [Migration("20250728052351_AddSeedData")]
            ...
            modelBuilder.Entity("BasicEfCoreDemo.Models.Invoice", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("886346f1-59ed-476e-a016-ed3ec4a7fa51"),
                            Amount = 100m,
                        ...
                        new
                        {
                            Id = new Guid("8111ec68-b487-4c0a-87d3-e9270f117bac"),
                            Amount = 200m,
                        ...
                        new
                        {
                            Id = new Guid("47451f2c-d773-43f6-a655-7308d57c1c09"),
                            Amount = 300m,
                            ContactName = "Thor",
                            Description = "Invoice for the first month",
                            DueDate = new DateTimeOffset(new DateTime(2021, 1, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
